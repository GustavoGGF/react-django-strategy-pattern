...
SECRET_KEY = 'django-insecure-9!hlwc=0ruf(u*i$31zau)=7llt3@3rx-i-ghnzfeoldy*&yco'
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "dist"],  # Diretórios adicionais para procurar templates.
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'root',
        'HOST': 'db-mysql', # Nome do serviço no Docker
        'PORT': '3306',
        'OPTIONS': {
...
STATICFILES_DIRS = (path.join(BASE_DIR, "dist/assets"),)
